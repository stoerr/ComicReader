...
public class XkcdTest extends InstrumentationTestCase {

    private String url = "https://xkcd.com/1936/";

    public void testHtmlParse() throws Exception {
        String fileName = "ComicsTest/xkcd.html";
        ...
        String parse = xkcd.parse(url, reader, strip);
