...
public class NumberPicker extends LinearLayout implements OnClickListener, OnFocusChangeListener, OnLongClickListener {
    ...
    public NumberPicker(Context context, AttributeSet attrs, int defStyle) {
        ...
        mSetButton = (Button) findViewById(R.id.numpicker_set);
        mCancelButton = (Button) findViewById(R.id.numpicker_cancel);
    ...
    public void onSetListener(View.OnClickListener l) {
    	mSetButton.setOnClickListener(l);
    }
    ...
    public int getCurrent() {
    	// before returing the value, just validate the input
    	validateInput(mText);
        return mCurrent;
    }
}
